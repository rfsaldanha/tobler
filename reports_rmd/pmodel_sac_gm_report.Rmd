---
title: "Spatial Autocorrelation Panel Model (SAC) with Generalized Moments (GM) estimator report"
...
* Lag external instrument variables: `r if_else("lag_instruments" %in% params$model_options, "Yes", "No")`
