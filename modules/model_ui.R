model_tab <- argonTabItem(
  ...
  argonTabSet(
    ...
    argonTab(
      ...
      actionButton("model_estimate_ols", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("model_estimate_sar_ml", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      active = FALSE,
      h3("SAR (STSLS)"),
      p("Spatial Autoregressive (SAR) model with Spatial Two Stage Least Squares (STSLS) estimator."),
      withMathJax("$$ y = \\lambda Wy + X \\beta + \\varepsilon $$"),
      checkboxGroupInput("model_sar_stsls_options", "Options", choices = c("Heteroskedasticity correction" = "is_robust")),
      actionButton("model_estimate_sar_stsls", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("model_estimate_sem_ml", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("model_estimate_sem_gmm", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("model_estimate_sac_ml", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      withMathJax("$$ y = \\lambda Wy + X \\beta + \\xi $$"),
      withMathJax("$$ \\xi = \\rho W \\xi + \\varepsilon $$"),
      checkboxGroupInput("model_sac_gstsls_options", "Options", choices = c("Use secondary weights matrix for error term" = "use_secondary_w_matrix", "Heteroskedasticity correction" = "is_robust")),
      actionButton("model_estimate_sac_gstsls", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("model_estimate_slx_ml", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("model_estimate_slx_stsls", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("model_estimate_sdm_ml", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("model_estimate_sdem_ml", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      uiOutput("model_sdem_gmm_durbin_var_UI"),
      actionButton("model_estimate_sdem_gmm", "Estimate", icon = icon("calculator"), status = "primary"),
      hr(),
      h4("Estimation"),
