pmodel_tab <- argonTabItem(
  ...
  argonTabSet(
    ...
    argonTab(
      ...
      actionButton("pmodel_hausman_test_execute", label = "Execute", icon = icon("calculator")), 
      hr(),
    ...
    argonTab(
      ...
      actionButton("pmodel_hausman_spatial_test_execute", label = "Execute", icon = icon("calculator")), 
      hr(),
    ...
    argonTab(
      ...
      actionButton("pmodel_pesaran_test_execute", label = "Execute", icon = icon("calculator")),
      hr(),
    ...
    argonTab(
      ...
      br(),br(),
      actionButton("pmodel_bsk_test_execute", label = "Execute", icon = icon("calculator")),
      hr(),
    ...
    argonTab(
      ...
      br(),br(),
      actionButton("pmodel_bsjk_test_execute", label = "Execute", icon = icon("calculator")),
      hr(),
  ...
  argonTabSet(
    ...
    argonTab(
      ...
      actionButton("pmodel_ols_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("pmodel_sar_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("pmodel_sar_gm_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("pmodel_sem_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("pmodel_sem_gm_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("pmodel_sac_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("pmodel_sac_gm_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("pmodel_sdem_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("pmodel_slx_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
    ...
    argonTab(
      ...
      actionButton("pmodel_slx_gm_estimate", label = "Estimate", icon = icon("calculator")),
      hr(),
      h4("Estimation"),
